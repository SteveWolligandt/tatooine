#ifndef TATOOINE_DETAIL_UNSTRUCTURED_SIMPLICIAL_GRID_TETRAHEDRAL_VTU_WRITER_H
#define TATOOINE_DETAIL_UNSTRUCTURED_SIMPLICIAL_GRID_TETRAHEDRAL_VTU_WRITER_H
//==============================================================================
...
struct tetrahedral_vtu_writer {
 ...
 private:
  ...
  auto write_appended_data_cells_types(std::ofstream& file) const {
    auto cell_types = std::vector<CellTypesInt>(m_grid.simplices().size(), 10);
