#ifndef TATOOINE_DETAIL_STRUCTURED_GRID_VERTEX_CONTAINER_H
#define TATOOINE_DETAIL_STRUCTURED_GRID_VERTEX_CONTAINER_H
//==============================================================================
#include <tatooine/concepts.h>
//#include <tatooine/detail/structured_grid/vertex_handle.h>
//#include <tatooine/detail/structured_grid/vertex_iterator.h>
...
struct vertex_container {
  ...
  //using iterator       = vertex_iterator<Real, NumDimensions, IndexOrder>;
