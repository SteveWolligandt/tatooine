#ifndef TATOOINE_GEOMETRY_VTK_XML_RECTILINEAR_GRID_H
#define TATOOINE_GEOMETRY_VTK_XML_RECTILINEAR_GRID_H
//==============================================================================
...
//==============================================================================
struct reader;
struct rectilinear_grid : piece_set {
  std::array<std::size_t, 3> whole_extent1;
  std::array<std::size_t, 3> whole_extent2;
  explicit rectilinear_grid(reader& r, rapidxml::xml_node<>* node)
      : piece_set{r, node} {
