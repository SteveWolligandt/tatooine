...
//==============================================================================
auto icon(const ImVec2& size, icon_type type, bool filled, const ImVec4& color,
          const ImVec4& innerColor) -> void {
  ...
  if (type == icon_type::flow) {
    ...
    if (type == icon_type::square) {
      if (filled) {
        ...
        drawList->AddRect(p0, p1, color, 0, 15 + extra_segments,
                          2.0f * outline_scale);
      }
    }

    if (type == icon_type::grid) {
      const auto r = 0.5f * rect_w / 2.0f;
    ...
    if (type == icon_type::round_square) {
      if (filled) {
        const auto r  = 0.5f * rect_w / 2.0f;
    ...
    } else if (type == icon_type::diamond) {
      if (filled) {
