...
struct spacetime_vectorfield
    : tatooine::spacetime_vectorfield<polymorphic::vectorfield<real_t, 2> const*, real_t, 3>,
      ui::node<spacetime_vectorfield> {
  spacetime_vectorfield(flowexplorer::scene& s)
      : tatooine::spacetime_vectorfield<polymorphic::vectorfield<real_t, 2> const*,
                                        real_t, 3>{nullptr},
        ui::node<spacetime_vectorfield>{"Space-Time Vector Field", s} {
    this->template insert_input_pin<polymorphic::vectorfield<real_t, 2>>(
        "2D Vector Field");
    this->template insert_output_pin<polymorphic::vectorfield<real_t, 3>>(
  ...
  void on_pin_connected(ui::input_pin& /*this_pin*/,
    ...
    this->set_field(
        dynamic_cast<polymorphic::vectorfield<real_t, 2> const*>(&other_pin.node()));
  }
