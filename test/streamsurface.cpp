...
TEST_CASE("streamsurface_spacetime_doublegyre_sampling",
  ...
  using integrator_t = ode::vclibs::rungekutta43<double, 2>;
  ...
  //  REQUIRE_FALSE(
  //      approx_equal(ssf.streamline_at(u).back_vertex(), seedcurve(u)));
  //}
  //{
  //  const double u = 1;
  ...
  //  REQUIRE_FALSE(
  //      approx_equal(ssf.streamline_at(u).front_vertex(), seedcurve(u)));
...
////==============================================================================
//TEST_CASE("streamsurface_doublegyre_caching",
...
//}
////==============================================================================
//TEST_CASE("streamsurface_doublegyre_front_evolving",
...
//    CHECK_FALSE(
//        approx_equal(ssf.vectorfield_at(0.5, 0), v(seedcurve(0.5), 0), 0));
...
//    CHECK_FALSE(
//        approx_equal(ssf.vectorfield_at(0.5, 2), v(seedcurve(0.5), 2), 0));
