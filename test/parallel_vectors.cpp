...
TEST_CASE("parallel_vectors_symbolic_doublegyre_acceleration",
          ...
          "[differentiate][acceleration]") {
  write_vtk(pv_acceleration(symbolic::doublegyre{}, linspace{0.0, 2.0, 201},
...
TEST_CASE(
  ...
  write_vtk(pv_acceleration(
                numerical::newdoublegyre{}, linspace{1e-3, 2.0 - 1e-3, 201},
                linspace{-1e-4, 1e-3, 101}, linspace{-10.0, 20.0, 401}),
...
TEST_CASE(
    ...
    "[parallel_vectors][pv][numerical][newdoublegyre][ndg][spacetime_field]"
    "[differentiate][jerk]") {
  write_vtk(pv_jerk(numerical::newdoublegyre{}, linspace{1e-3, 2.0 - 1e-3, 201},
                    linspace{-1e-4, 1e-3, 101}, linspace{-10.0, 20.0, 401}),
...
TEST_CASE(
    ...
    "[differentiate][acceleration]") {
  write_vtk(pv_acceleration(symbolic::newdoublegyre{}, linspace{0.0, 2.0, 201},
                            linspace{-1.0, 1.0, 101}, linspace{0.0, 10.0, 401}),
...
TEST_CASE(
    ...
    "[parallel_vectors][pv][symbolic][newdoublegyre][ndg][spacetime_field]"
    "[differentiate][jerk]") {
  write_vtk(pv_jerk(symbolic::newdoublegyre{}, linspace{0.0, 2.0, 201},
                    linspace{-1.0, 1.0, 101}, linspace{0.0, 10.0, 401}),
