...
TEST_CASE("integration_vclibs_stdg_rk43",
          "[integration][vclibs][rk43][rungekutta43][doublegyre][numerical][spacetime_field]") {
  symbolic::doublegyre dg;
  spacetime_field stdg{dg};
  integration::vclibs::rungekutta43<double, 3> rk43;
  rk43.integrate(stdg, {0.1, 0.1, 0.0}, 0, 30);
  rk43.integrate(stdg, {0.1, 0.1, 0.0}, 0, -30).write_vtk("spacetime_dg_pathline_0_1.vtk");
  rk43.integrate(stdg, {0.2, 0.2, 0.0}, 0, 30);
  rk43.integrate(stdg, {0.2, 0.2, 0.0}, 0, -30).write_vtk("spacetime_dg_pathline_0_2.vtk");
}
