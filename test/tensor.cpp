...
TEST_CASE("tensor_inverse", "[tensor][inverse]") {
  ...
  SECTION("3x3"){} {
    SECTION("symmetric") {
      mat const A{{1.064928271071055e+02, 5.634642453472562e+01, -3.402565790227180e+01},
                  {5.634642453472562e+01, 4.267363152922029e+01, -3.444091660187971e+01},
                  {-3.402565790227180e+01, -3.444091660187971e+01, 1.901133286147969e+02}};
      mat const invA{{3.196413521586861e-02, -4.402539061060532e-02, -2.254834416457464e-03},
                     {-4.402539061060532e-02, 8.808445663148774e-02, 8.077900460878503e-03},
                     {-2.254834416457464e-03, 8.077900460878503e-03, 6.319851850288617e-03}};
      INFO("A = \n" << A);
      INFO("inv(A) = \n" << *inv(A));
      INFO("inv_sym(A) = \n" << *inv_sym(A));
      INFO("invA = \n" << invA);
    ...
    SECTION("non-symmetric") {
      mat const A{
          ...
          {-8.665651707796259e+00, 7.017073536451740e+00, -8.110517127655505e+00}};
      mat const invA{{ 1.312234927387698e-01, -2.233939031857682e-01, -6.256571756846976e-02},
                     { 1.141285533158541e-01, -6.151950324683048e-02,  4.619131457920062e-02},
                     {-4.146327878179570e-02,  1.854588131396796e-01, -1.648469874994442e-02}};
      INFO("A = \n" << A);
      INFO("inv(A) = \n" << *inv(A));
      INFO("invA = \n" << invA);
      REQUIRE(approx_equal(*inv(A), invA));
...
//}
////==============================================================================
//TEST_CASE("tensor_solve_cramer_vector_3d", "[tensor][solve][cramer][vector][3d]") {
//  auto A = mat{{0.8274851323427, 0.3487297112442, 0.4876777015539},
...
//  REQUIRE(X(0, 0) == Approx(X_expected(0,0)));
//  REQUIRE(X(1, 0) == Approx(X_expected(1,0)));
//  REQUIRE(X(0, 1) == Approx(X_expected(0,1)));
//  REQUIRE(X(1, 1) == Approx(X_expected(1,1)));
//  REQUIRE(X(0, 2) == Approx(X_expected(0,2)));
//  REQUIRE(X(1, 2) == Approx(X_expected(1,2)));
//  REQUIRE(X(0, 3) == Approx(X_expected(0,3)));
//  REQUIRE(X(1, 3) == Approx(X_expected(1,3)));
//}
////==============================================================================
