...
TEST_CASE("static_multidim_stack_array", "[multidim_array][static][stack]") {
  SECTION("x_fastest") {
    static_multidim_array<int, x_fastest, stack, 3, 4, 2> arr{1};
  ...
  SECTION("x_slowest") {
    static_multidim_array<int, x_slowest, stack, 3, 4, 2> arr{1};
    REQUIRE(arr.num_dimensions() == 3);
    REQUIRE(arr.num_elements() == 3 * 4 * 2);
    REQUIRE(arr(1, 1, 1) == 1);
...
TEST_CASE("static_multidim_heap_array", "[multidim_array][static][heap]") {
  SECTION("x_fastest") {
    static_multidim_array<int, x_fastest, heap, 3, 4, 2> arr{1};
    REQUIRE(arr.num_dimensions() == 3);
    REQUIRE(arr.num_elements() == 3 * 4 * 2);
    REQUIRE(arr(1, 1, 1) == 1);
    REQUIRE(arr[1 + 3 + 3 * 4] == 1);
  ...
  SECTION("x_slowest") {
    static_multidim_array<int, x_slowest, heap, 3, 4, 2> arr{1};
    REQUIRE(arr.num_dimensions() == 3);
    REQUIRE(arr.num_elements() == 3 * 4 * 2);
    REQUIRE(arr(1, 1, 1) == 1);
    REQUIRE(arr[1 + 2 + 2 * 4] == 1);
    ...
    static_multidim_array<int, x_fastest, stack, 3, 4, 2> arr2;
    arr2.randu();
    arr = arr2;
    for (auto is : arr.indices()) { REQUIRE(arr(is) == arr2(is)); }
  }
...
TEST_CASE("dynamic_multidim_array", "[multidim_array][dynamic]") {
  SECTION("x_fastest") {
    ...
    dynamic_multidim_array<int, x_slowest> arr2{std::vector<size_t>{3, 4, 2}};
    arr2.randu();
    arr = arr2;
    for (auto is : arr.indices()) { REQUIRE(arr(is) == arr2(is)); }
  }
  SECTION("x_slowest") {
    ...
    dynamic_multidim_array<int, x_fastest> arr2{std::vector<size_t>{3, 4, 2}};
    arr2.randu();
    arr = arr2;
    for (auto is : arr.indices()) { REQUIRE(arr(is) == arr2(is)); }
  }
