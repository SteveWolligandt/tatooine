...
//==============================================================================
class camera;
static bool verbose = TATOOINE_RENDERING_GL_VERBOSE;
...
//----------------------------------------------------------------------------
DLL_API void get_booleani_v(GLenum target, GLuint index,
                                   GLboolean* data);
...
DLL_API void get_integer64i_v(GLenum target, GLuint index,
                                     GLint64* data);
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
DLL_API void blend_func_separate(GLenum srcRGB, GLenum dstRGB,
                                        GLenum srcAlpha, GLenum dstAlpha);
DLL_API void blend_func_separate_i(GLuint buf, GLenum srcRGB,
...
//----------------------------------------------------------------------------
DLL_API void vertex_attrib_i_pointer(GLuint index, GLint size,
                                            GLenum type, GLsizei stride,
                                            const GLvoid* pointer);
//----------------------------------------------------------------------------
DLL_API void vertex_attrib_l_pointer(GLuint index, GLint size,
                                            GLenum type, GLsizei stride,
                                            const GLvoid* pointer);
//----------------------------------------------------------------------------
...
// BUFFER RELATED
//============================================================================
DLL_API void buffer_data(GLenum target, GLsizeiptr size,
                                const void* data, GLenum usage);
//----------------------------------------------------------------------------
DLL_API void named_buffer_data(GLuint buffer, GLsizeiptr size,
                                      const void* data, GLenum usage);
//----------------------------------------------------------------------------
DLL_API void bind_buffer(GLenum target, GLuint buffer);
//----------------------------------------------------------------------------
DLL_API void bind_buffer_base(GLenum target, GLuint index,
                                     GLuint buffer);
...
//----------------------------------------------------------------------------
DLL_API void copy_named_buffer_sub_data(GLuint   readBuffer,
                                               GLuint   writeBuffer,
                                               GLintptr readOffset,
...
//----------------------------------------------------------------------------
DLL_API auto map_buffer_range(GLenum target, GLintptr offset,
...
void named_buffer_data(GLuint buffer, GLsizei size, const T* data,
  ...
  if (verbose) {
    if constexpr (std::is_arithmetic_v<T>) {
      ...
      verbose_ostream << "glNamedBufferData(" << buffer << ", " << size << ", " << data
           << ", " << to_string(usage) << ")\n";
    }
  }
  ...
  //----------------------------------------------------------------------------
  DLL_API void buffer_sub_data(GLenum target, GLintptr offset,
                                      GLsizeiptr size, const GLvoid* data);
  //----------------------------------------------------------------------------
  DLL_API void named_buffer_sub_data(GLuint buffer, GLintptr offset,
                                            GLsizei size, const void* data);
  //----------------------------------------------------------------------------
  DLL_API void get_buffer_parameter_iv(GLenum target, GLenum value,
                                              GLint* data);
  //----------------------------------------------------------------------------
  DLL_API void clear_named_buffer_data(GLuint buffer,
  ...
  //----------------------------------------------------------------------------
  DLL_API void shader_source(GLuint shader, GLsizei count,
  ...
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_1f(GLuint program, GLint location,
                                         GLfloat v0);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_2f(GLuint program, GLint location,
                                         GLfloat v0, GLfloat v1);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_3f(GLuint program, GLint location,
                                         GLfloat v0, GLfloat v1, GLfloat v2);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_4f(GLuint program, GLint location,
                                         GLfloat v0, GLfloat v1, GLfloat v2,
                                         GLfloat v3);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_1i(GLuint program, GLint location,
                                         GLint v0);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_2i(GLuint program, GLint location,
                                         GLint v0, GLint v1);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_3i(GLuint program, GLint location,
                                         GLint v0, GLint v1, GLint v2);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_4i(GLuint program, GLint location,
                                         GLint v0, GLint v1, GLint v2,
                                         GLint v3);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_1ui(GLuint program, GLint location,
                                          GLuint v0);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_2ui(GLuint program, GLint location,
                                          GLuint v0, GLuint v1);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_3ui(GLuint program, GLint location,
                                          GLuint v0, GLuint v1, GLuint v2);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_4ui(GLuint program, GLint location,
                                          GLuint v0, GLuint v1, GLuint v2,
                                          GLuint v3);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_1fv(GLuint program, GLint location,
                                          GLsizei count, const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_2fv(GLuint program, GLint location,
                                          GLsizei count, const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_3fv(GLuint program, GLint location,
                                          GLsizei count, const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_4fv(GLuint program, GLint location,
                                          GLsizei count, const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_1iv(GLuint program, GLint location,
                                          GLsizei count, const GLint* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_2iv(GLuint program, GLint location,
                                          GLsizei count, const GLint* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_3iv(GLuint program, GLint location,
                                          GLsizei count, const GLint* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_4iv(GLuint program, GLint location,
                                          GLsizei count, const GLint* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_1uiv(GLuint program, GLint location,
                                           GLsizei count, const GLuint* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_2uiv(GLuint program, GLint location,
                                           GLsizei count, const GLuint* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_3uiv(GLuint program, GLint location,
                                           GLsizei count, const GLuint* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_4uiv(GLuint program, GLint location,
                                           GLsizei count, const GLuint* value);
  //----------------------------------------------------------------------------
  ...
  DLL_API void program_uniform_matrix_4fv(GLuint program, GLint location,
                                                 ...
                                                 const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_matrix_2x3fv(GLuint         program,
                                                   GLint          location,
                                                   GLsizei        count,
                                                   GLboolean      transpose,
                                                   const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_matrix_3x2fv(GLuint         program,
                                                   GLint          location,
                                                   GLsizei        count,
                                                   GLboolean      transpose,
                                                   const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_matrix_2x4fv(GLuint         program,
                                                   GLint          location,
                                                   GLsizei        count,
                                                   GLboolean      transpose,
                                                   const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_matrix_4x2fv(GLuint         program,
                                                   GLint          location,
                                                   GLsizei        count,
                                                   GLboolean      transpose,
                                                   const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_matrix_3x4fv(GLuint         program,
                                                   GLint          location,
                                                   GLsizei        count,
                                                   GLboolean      transpose,
                                                   const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void program_uniform_matrix_4x3fv(GLuint         program,
                                                   GLint          location,
                                                   GLsizei        count,
                                                   GLboolean      transpose,
                                                   const GLfloat* value);
  //----------------------------------------------------------------------------
  DLL_API void get_program_iv(GLuint program, GLenum pname,
                                     GLint* params);
  //----------------------------------------------------------------------------
  DLL_API void get_program_info_log(GLuint program, GLsizei maxLength,
                                           GLsizei* length, GLchar* infoLog);
  //----------------------------------------------------------------------------
  DLL_API auto get_uniform_location(GLuint program, const GLchar* name)
      -> GLint;
  //============================================================================
  // TEXTURE RELATED
  //============================================================================
  DLL_API void create_textures(GLenum target, GLsizei n,
                                      GLuint* textures);
  //----------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------
  DLL_API void bind_image_texture(GLuint unit, GLuint texture,
                                         GLint level, GLboolean layered,
                                         GLint layer, GLenum access,
                                         GLenum format);
  //----------------------------------------------------------------------------
  DLL_API void tex_image_1d(GLenum target, GLint level,
                                   GLint internal_format, GLsizei width,
                                   GLint border, GLenum format, GLenum type,
                                   const GLvoid* data);
  //----------------------------------------------------------------------------
  DLL_API void tex_image_2d(GLenum target, GLint level,
                                   GLint internal_format, GLsizei width,
                                   GLsizei height, GLint border, GLenum format,
                                   GLenum type, const GLvoid* data);
  //----------------------------------------------------------------------------
  DLL_API void tex_sub_image_2d(GLenum target, GLint level,
                                       GLint xoffset, GLint yoffset,
                                       GLsizei width, GLsizei height,
                                       GLenum format, GLenum type,
                                       const GLvoid* pixels);
  //----------------------------------------------------------------------------
  DLL_API void texture_sub_image_1d(GLuint texture, GLint level,
                                           GLint xoffset, GLsizei width,
                                           GLenum format, GLenum type,
                                           const void* pixels);
  //----------------------------------------------------------------------------
  DLL_API void texture_sub_image_2d(GLuint texture, GLint level,
                                           GLint xoffset, GLint yoffset,
                                           GLsizei width, GLsizei height,
                                           GLenum format, GLenum type,
                                           const void* pixels);
  //----------------------------------------------------------------------------
  DLL_API void texture_sub_image_3d(GLuint texture, GLint level,
                                           GLint xoffset, GLint yoffset,
                                           ...
                                           const void* pixels);
  //----------------------------------------------------------------------------
  DLL_API void tex_image_3d(GLenum target, GLint level,
                                   GLint internal_format, GLsizei width,
                                   GLsizei height, GLsizei depth, GLint border,
                                   GLenum format, GLenum type,
                                   const GLvoid* data);
  //----------------------------------------------------------------------------
  DLL_API void copy_image_sub_data(
  ...
  DLL_API void get_n_tex_image(GLenum target, GLint level, GLenum format,
                                      ...
                                      void* pixels);
  //----------------------------------------------------------------------------
  DLL_API void get_texture_image(GLuint texture, GLint level,
                                        GLenum format, GLenum type,
                                        GLsizei bufSize, void* pixels);
  //----------------------------------------------------------------------------
  DLL_API void get_texture_sub_image(GLuint texture, GLint level,
                                            GLint xoffset, GLint yoffset,
                                            GLint zoffset, GLsizei width,
                                            GLsizei height, GLsizei depth,
                                            GLenum format, GLenum type,
                                            GLsizei bufSize, void* pixels);
  //----------------------------------------------------------------------------
  DLL_API void tex_parameter_f(GLenum target, GLenum pname,
                                      GLfloat param);
  //----------------------------------------------------------------------------
  DLL_API void tex_parameter_i(GLenum target, GLenum pname, GLint param);
  //----------------------------------------------------------------------------
  DLL_API void texture_parameter_f(GLuint texture, GLenum pname,
                                          GLfloat param);
  //----------------------------------------------------------------------------
  DLL_API void texture_parameter_i(GLuint texture, GLenum pname,
                                          GLint param);
  //----------------------------------------------------------------------------
  DLL_API void tex_parameter_fv(GLenum target, GLenum pname,
                                       const GLfloat* params);
  //----------------------------------------------------------------------------
  DLL_API void tex_parameter_iv(GLenum target, GLenum pname,
                                       const GLint* params);
  //----------------------------------------------------------------------------
  ...
  DLL_API void texture_parameter_Iuiv(GLuint texture, GLenum pname,
                                             const GLuint* param);
  //----------------------------------------------------------------------------
  DLL_API void clear_tex_image(GLuint texture, GLint level,
                                      GLenum format, GLenum type,
                                      const void* data);
  //----------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------
  DLL_API void named_framebuffer_texture(GLuint framebuffer,
                                                GLenum attachment,
                                                GLuint texture, GLint level);
  //----------------------------------------------------------------------------
  DLL_API auto check_named_framebuffer_status(GLuint framebuffer,
                                                     GLenum target) -> GLenum;
  //----------------------------------------------------------------------------
  DLL_API void named_framebuffer_draw_buffers(GLuint        framebuffer,
                                                     GLsizei       n,
                                                     const GLenum* bufs);
  //----------------------------------------------------------------------------
