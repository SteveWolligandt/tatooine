...
#include <tatooine/rendering/gl/linked_list_texture.h>
...
class steadification {
 ...
 private:
  ...
  rendering::gl::orthographiccamera          m_cam;
 ...
 public:
  ...
  rendering::gl::shaderstoragebuffer<GLfloat> m_weight_buffer;
 ...
 public:
  steadification(const field<V, real_t, 2, 2>& v,
      ...
      : m_v{v.as_derived()},
        ...
        m_cam{static_cast<float>(domain.min(0)),
              ...
              render_resolution(0),
              render_resolution(1)},
        m_color_scale{rendering::gl::LINEAR, yavin::CLAMP_TO_EDGE, "color_scale.png"},
        m_noise_tex{rendering::gl::LINEAR, yavin::REPEAT, render_resolution(0),
                    render_resolution(1)},
  ...
  void render_seedcurves(const grid_t&              domain,
    ...
    rendering::gl::framebuffer fbo{m_seedcurvetex};
    fbo.bind();
    rendering::gl::clear_color(255, 255, 255, 0);
    rendering::gl::clear_color_buffer();
