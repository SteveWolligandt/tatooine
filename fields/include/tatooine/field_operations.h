...
constexpr auto dot(vectorfield<V0, Real0, NumDimensions> const& lhs,
...
//------------------------------------------------------------------------------
template <typename V0, typename Real0, typename V1, typename Real1, std::size_t N,
          typename Tensor>
...
//------------------------------------------------------------------------------
template <typename V, typename VReal, std::size_t N, arithmetic_or_complex ScalarReal,
          typename Tensor>
constexpr auto operator/(field<V, VReal, N, Tensor> const& f,
...
// template <typename lhs_tensor_type, typename Real0,
//          typename rhs_tensor_type, typename Real1, std::size_t M, std::size_t N>
